...
- > **Note:** Make a note of this username and password for future use
...
- > **Note:** Make a note of this **User ID** and **Password**. These
...
- ![](./media/image30.png)
  ...
  > **Note:** The username and password will be the login details of
